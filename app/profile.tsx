...
//sets variables to default inputs
export default function ProfilePage() {
    ...
    const pickImage = async () => {
        ...
        //checks file size but not sure if I should change it to greater or not
    ...
    return (
        <SafeAreaView style={styles.container}>
            <ScrollView contentContainerStyle={styles.scrollViewContent}>
                ...
                //displays text with ability to change set values with onChangeText
                    </TouchableOpacity>
